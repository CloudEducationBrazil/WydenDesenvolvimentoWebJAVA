...
public class TokenRetornoApiContabilidadeDTO {

    private String id;

    //@Size(min = 14, max = 14) Validação de Dados (Bean Validation)
    //@NotNull Validação de Dados (Bean Validation)
	//@Pattern
    private String cnpj;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		TokenRetornoApiContabilidadeDTO other = (TokenRetornoApiContabilidadeDTO) obj;
